...
export const metadata: Metadata = {
  title: "Programa de parcerias — indique e receba 3,00% do valor líquido liberado",
  description:
    "Indique clientes para crédito com garantia de imóvel, acompanhe cada etapa pelo portal e receba 3,00% de comissão sobre o valor líquido liberado ao cliente. Credios, desde 2019.",
...
const steps = [
  ...
  },
  {
    ...
    description:
      "Quando o crédito sai, sua comissão de 3,00% sobre o valor líquido liberado é gerada automaticamente.",
  },
] as const;
...
const faq = [
  {
    ...
    a: "3,00% sobre o valor líquido da operação — o que efetivamente cai na conta do cliente, já descontados tributos, tarifas e demais custos retidos na liberação. Em uma liberação líquida de R$ 500.000, são R$ 15.000. A comissão aparece no portal assim que o crédito sai e o pagamento é feito em poucos dias úteis.",
  },
  {
            ...
            <Reveal delay={80}>
              <h1 className="t-display-lg text-credios-charcoal mt-4">
                ...
                <span className="text-credios-blue">
                  Receba 3,00% do valor líquido liberado.
                </span>
              </h1>
            </Reveal>
            <Reveal delay={160}>
          ...
          <Reveal>
            <Card tone="dark" unpadded className="px-6 py-10 sm:px-12 sm:py-14 text-center">
              ...
              <p className="t-caption text-white/60 mt-4">
                Comissão de 3,00% sobre o valor líquido liberado — sem teto, sem limite
                de indicações.
              </p>
            </Card>
          </Reveal>
