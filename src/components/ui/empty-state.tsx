...
export function EmptyState({
  ...
  return (
    <div className="flex flex-col items-center justify-center gap-3 rounded-lg border border-dashed border-neutral-200 bg-white px-8 py-16 text-center">
      <span className="flex size-14 items-center justify-center rounded-full bg-gradient-to-br from-credios-blue-50 to-credios-blue-100">
        <Icon size={24} className="text-credios-blue" aria-hidden />
      </span>
